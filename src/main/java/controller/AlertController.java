...
//            alert.getDialogPane().setMaxSize(300, 150); // Set the maximum size of the alert dialog pane
        ...
        alert.getDialogPane().setStyle("-fx-background-color: linear-gradient(to top right  ,#65376f, #893a3a, #f38282,black);");
        alert.getDialogPane().setHeaderText(null); // Remove the header text from the alert dialog pane


        Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
        stage.getIcons().add(new javafx.scene.image.Image("assets/icons8-help-100.png"));
    ...
    public static void animationMesseageCorect(String Title, String Message) {
        ...
        javafx.scene.image.Image image = new javafx.scene.image.Image("assets/icons8-ok.gif");

        // Create an alert with a title, message, and icon
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle(Title);
        alert.setHeaderText(Message);
        alert.getDialogPane().setBackground(new Background(new BackgroundFill(javafx.scene.paint.Color.BLACK, null, null)));
        alert.getDialogPane().setStyle("-fx-background-color: linear-gradient(to top right  ,#65376f, #893a3a, #f38282,black);");
        alert.getDialogPane().lookup(".header-panel .label").setStyle("-fx-text-fill: red;");
        Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
        stage.getIcons().add(new javafx.scene.image.Image("assets/icons8-ok.gif"));
    ...
    public static void animationMesseagewrong(String Title, String Message) {
        ...
        alert.setGraphic(new ImageView(image));
        Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
        stage.getIcons().add(new javafx.scene.image.Image("assets/icons8-high-importance-96.png"));
